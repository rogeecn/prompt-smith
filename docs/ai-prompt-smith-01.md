...
*   **A2. 三种进入模式**
    *   **向导模式 (Wizard Mode)**：默认模式。从零开始，通过系统预设的问题树进行引导。
...
*   **F5. 导出与分享**
    *   支持导出：JSON (完整配置)、Markdown (提示词文本)。
    *   URL 分享：生成只读链接，通过链接查看结果。
